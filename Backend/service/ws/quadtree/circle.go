...
func TranslateCircle(circle Circle, offset *Point) Circle {
	return Circle{Center: Point{X: circle.Center.X + offset.X, Y: circle.Center.Y + offset.Y}, Radius: circle.Radius}
}
